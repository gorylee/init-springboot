package com.openAi.yunchat.core.base;
...
public class JsonResult<T> {
    ...
    public static <T> JsonResult<T> ok(){
        return new JsonResult<>(ResultEnum.SUCCESS.getKey(),"success");
    }
    public static <T> JsonResult<T> ok(Integer status){
        return new JsonResult<>(status,"success");
    }
    public static <T> JsonResult<T> ok(T data){
        return new JsonResult<>(ResultEnum.SUCCESS.getKey(), "success", data);
    }
    ...
    public static <T> JsonResult<T> fail(){
        return new JsonResult<>(ResultEnum.FAIL.getKey(),"fail");
    }
